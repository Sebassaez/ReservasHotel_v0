...
public class Reserva {
    ...
    public Reserva(Habitacion habitacion, LocalDate fechaInicio, LocalDate fechaFin, int numeroPersonas, Regimen regimen) {
        if (habitacion == null) {
    ...
    public void setHabitacion(Habitacion habitacion) {
        if (habitacion == null) {
            throw new NullPointerException("Habitación no válida");
        }
    ...
    // Método privado para calcular el precio de la reserva
    private double calcularPrecio() {
        double costoHabitacion = habitacion.getPrecio() * numeroPersonas;
        return costoHabitacion + (regimen.getIncrementoPrecio() * numeroPersonas);
    }
